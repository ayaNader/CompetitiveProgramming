/*
  idea:
  - saving the ranking when ep=20 and keeping the realation between every pair with equal number of problems
  - then trying all possible ep's and minimizing and maximizing the ones that dont change the rank
*/
#include<bits/stdc++.h>
using namespace std;
